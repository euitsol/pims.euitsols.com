                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="float-right">
                            @if(Auth::user()->can('add shift') || Auth::user()->role->id == 1)<a href="{{ route('shift.create') }}" class="btn btn-info">Add new Shift</a>@endif
                        </span>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-middle py-0 align-middle">
                                                <div class="btn-group">
                                                    ...
                                                    <a href="{{ route('shift.edit', $d->id) }}"
                                                        class="btn btn-dark btnEdit"><i class="fas fa-edit"></i></a>
                                                    @endif
                                                    @if (Auth::user()->can('delete shift') || Auth::user()->role->id == 1)
                                                    <a href="{{ route('shift.destroy', $d->id) }}" class="btn btn-danger btnDelete"><i class="fas fa-trash"></i></a>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
