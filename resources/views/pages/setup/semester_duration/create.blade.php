                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-10 m-auto">
                            <form action="{{ route('semesterDuration.store') }}" method="POST" class="form-horizontal">
                            @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 row">
                                        <div class="col-lg-11 col-10">
                                            <select class="form-control" id="session" name="session" required>
                                                ...
                                                @foreach($sessions as $session)
                                                    <option value="{{ $session->id }}" @if( old('session') == $session->id) selected @endif>{{ $session->start }} - {{ $session->end }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-1 col-2 text-right pr-0 rounded-0">
                                        ...
                                        <div class="col-lg-11 col-10">
                                            <select class="form-control" id="semester" name="semester" required>
                                                ...
                                                @foreach($semesters as $semester)
                                                    <option value="{{ $semester->id }}" @if( old('semester') == $semester->id) selected @endif>{{ $semester->name }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-daterange" id="year">
                                            <input type="text" class="form-control" id="start_month" name="start_month" value={{ old('start_month') }}>
                                        <div class="input-group-append"><div class="input-group-text">to</div></div>
                                            <input type="text" class="form-control" id="end_month" name="end_month" value={{ old('end_month') }}>
                                        </div>
