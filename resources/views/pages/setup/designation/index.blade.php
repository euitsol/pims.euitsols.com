                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="float-right">
                            @if(Auth::user()->can('add designation') || Auth::user()->role->id == 1)<a href="{{ route('designation.create') }}" class="btn btn-info">Add new Designation</a>@endif
                        </span>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-middle py-0 align-middle">
                                                <div class="btn-group">
                                                    ...
                                                    <a href="{{ route('designation.edit', $d->id) }}"
                                                        class="btn btn-dark btnEdit"><i class="fas fa-edit"></i></a>
                                                    @endif
                                                    @if (Auth::user()->can('delete designation') || Auth::user()->role->id == 1)
                                                    <a href="{{ route('designation.destroy', $d->id) }}" class="btn btn-danger btnDelete"><i class="fas fa-trash"></i></a>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
        ...
        $(document).ready(function() {
            ...
            $('#table').on('click', 'tbody tr td .btn-group .btnView', function () {
                if ($(this).data('id') != null || $(this).data('id') != '') {
                    let url = ("{{ route('designation.show', ['id']) }}");
