                ...
                <div class="card">
                    <div class="card-header">
                        <span class="float-left">
                            <h4>View Letter Grades</h4>
                        </span>
                        <span class="float-right">
                            @if(Auth::user()->can('add letter-grade') || Auth::user()->role->id == 1)<a href="{{ route('lettergrade.create') }}" class="btn btn-info">Add new Letter Grade</a>@endif
                        </span>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-middle py-0 align-middle">
                                                <div class="btn-group">
                                                    ...
                                                    <a href="{{ route('lettergrade.edit', $d->id) }}"
                                                        class="btn btn-dark btnEdit"><i class="fas fa-edit"></i></a>
                                                    @endif
                                                    @if (Auth::user()->can('delete letter-grade') || Auth::user()->role->id == 1)
                                                    <a href="{{ route('lettergrade.destroy', $d->id) }}" class="btn btn-danger btnDelete"><i class="fas fa-trash"></i></a>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
        ...
        $(document).ready(function() {
            ...
            $('.btnView').click(function() {
                if ($(this).data('id') != null || $(this).data('id') != '') {
                    let url = ("{{ route('lettergrade.show', ['id']) }}");
