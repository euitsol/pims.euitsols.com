            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="float-right">
                        @if(Auth::user()->can('add asset-brand') || Auth::user()->role->id == 1)<a href="{{ route('asset.setup.brand.create') }}" class="btn btn-info">Add new brand</a>@endif
                    </span>
                </div>
                <div class="card-body">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            @if(Auth::user()->can('edit brand') || Auth::user()->role->id == 1)
                                                <a href="{{ route('asset.setup.brand.edit', $brand->id) }}" class="btn btn-dark btnEdit"><i class="fas fa-edit"></i></a>
                                            @endif
                                            @if(Auth::user()->can('delete brand') || Auth::user()->role->id == 1)
                                                <a href="{{ route('asset.setup.brand.destroy', $brand->id) }}" class="btn btn-danger btnDelete"><i class="fas fa-trash"></i></a>
                                            @endif
                                        </div>
                                    </td>
                                   </tr>
