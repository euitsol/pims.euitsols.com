...
@section('title', 'Asset Management - Subsection')
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="float-right">
                        @if(Auth::user()->can('add subsection') || Auth::user()->role->id == 1)<a href="{{ route('asset.setup.subsection.create') }}" class="btn btn-info">Add new subsection</a>@endif
                    </span>
                </div>
                <div class="card-body">
                                   ...
                                   <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            @if(Auth::user()->can('edit subsection') || Auth::user()->role->id == 1)
                                                <a href="{{ route('asset.setup.subsection.edit', $subsection->id) }}" class="btn btn-dark btnEdit"><i class="fas fa-edit"></i></a>
                                            @endif
                                            @if(Auth::user()->can('delete subsection') || Auth::user()->role->id == 1)
