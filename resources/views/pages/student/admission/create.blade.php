                            ...
                            <form action="{{ route('department.store') }}" method="POST" class="form-horizontal">
                                    ...
                                    <fieldset>
                                        ...
                                        {{-- <div class="row"> --}}
                                            ...
                                            <div class="col-md-12 text-right">
                                                <button type="button" class="next btn btn-success" onclick="run(1,2)">Next</button>
                                            </div>
                                        {{-- </div> --}}
                                    </fieldset>
                                </div>
                                <div class="tab" id="tab-2">
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 text-left">
                                                <button type="button" class="previous btn btn-success" onclick="run(2,1)">Previous</button>
                                            </div>
                                            <div class="col-md-6 text-right">
                                                <button type="button" class="next btn btn-success" onclick="run(2,3)">Next</button>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 text-left">
                                            <button type="button" class="previous btn btn-success" onclick="run(3,2)">Previous</button>
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
...
<script>
    ...
    function run(hideTabe,showTabe){
        // $('#step1').css('opacity','1')
        ...
        //progessbar
        for(i=1;i<showTabe;i++){
            console.log('yes step');
    ...
    //     $(".next").click(function(){
    //         if($( "fieldset" ).eq(0).css("display") == "show"){
