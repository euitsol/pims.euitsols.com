            ...
            <div class="col-md-10 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="float-right">
                            <a href="{{ route('employee.admitted.decline.list') }}" class="btn btn-info">Back</a>
                        </span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-10 m-auto">
                                ...
                                <form action="{{ route('employee.admitted.decline.update') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
