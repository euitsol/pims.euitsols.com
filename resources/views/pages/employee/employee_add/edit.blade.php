                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-10 m-auto">
                                ...
                                <form action="{{ route('employee.new_employee.update',$data->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
    ...
    function file_upload(selectors, name){
        ...
        $('#add_more2').click(function(){
            ...
            result = `<div class="row shadow-lg p-3 mb-5 bg-body rounded" id="aca_mod_${count}">
                        ...
                        <div class="col-md-6 text-right">
                            <button type="button" class="btn btn-danger" onclick="delete_section2(${count})">Remove</button>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
        ...
        function delete_section2(count) {
            $('#aca_mod_' + count).remove();
        };
